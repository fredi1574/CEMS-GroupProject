...
//        }
    ...
    public void pickQuestion(ActionEvent event) {
        menu.goToNewScreen(event, "CreateNewTestScreen/PickQuestionsScreen/PickQuestions.fxml", "C.E.M.S Test Manager - Pick Questions");
//        try {
...
//        }
    ...
    public void openPreview(ActionEvent event) {
        menu.goToNewScreen(event, "CreateNewTestScreen/TestPreviewPopUp.fxml", "C.E.M.S Test Manager - Test Preview");
//        try {
